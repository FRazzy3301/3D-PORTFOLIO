...
export default class MonitorScreen extends EventEmitter {
    ...
    /// setting up all the vars monitos screen will be taking 
   /// the callback urls parteining the screen logic
...
/// setting up all the event listeners the monitors screen wilbe talking 
    ...
    createIframe() {
        ...
        // PROD
        iframe.src = 'https://os-web-simulation-ji6k-p85qdoc2p-frazzy3301s-projects.vercel.app/projects';
        /**
